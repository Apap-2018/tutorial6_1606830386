...
public class FlightServiceTest {
	...
	@TestConfiguration //Untuk membatasi scope Bean yang di definisikan menjadi local class
	...
	public void whenValidFlightNumber_thenFlightShouldBeFound() {
		...
		Mockito.when(flightDb.findByFlightNumber(flight.get().getFlightNumber())).thenReturn(flight);//JELASKAN INIIIII
